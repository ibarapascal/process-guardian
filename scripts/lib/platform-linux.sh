#!/bin/bash
# =============================================================================
# Process Guardian - Linux Implementation
# =============================================================================
...
scan_and_clean_linux() {
    ...
    # Note: Linux uses 'args' instead of 'command'
    ...
    done < <(ps -eo pid,ppid,pcpu,pmem,etime,args | awk '$2 == 1' | grep -E "$filter_pattern" 2>/dev/null || true)
